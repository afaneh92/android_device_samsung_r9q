...
Supported Models
-------------
Galaxy S21 FE (Snapdragon): G9900 and G990B.

Download & Guide
-------------
                
1. Unlock your bootloader.
2. Downloads for Galaxy S21 FE (Snapdragon): [r9q](https://www.androidfilehost.com/?w=files&flid=334089)
3. Reboot to download mode
4. Uncheck auto reboot in Odin and flash TWRP in AP slot and [vbmeta_disabled.tar](https://github.com/afaneh92/android_device_samsung_r9q/raw/github.io/docs/vbmeta_disabled.tar) in USERDATA slot.
...
Sources
-------------
[Kernel tree](https://github.com/afaneh92/android_kernel_samsung_r9q)

[Device tree](https://github.com/afaneh92/android_device_samsung_r9q)

Changelog
-------------
[GitHub History](https://github.com/afaneh92/android_device_samsung_r9q/commits/android-12.1)
